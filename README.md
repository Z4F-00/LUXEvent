 ...
 * > Jika anda sudah menyimpan file atau script yang ada di Dashboard ini, maka langkah-langkah sebelumnya tidak perlu anda lakukan.
 * Pindahkan file yang sudah anda simpan atau anda buat ke Folder Auto-Execute: Simpan file tersebut ke lokasi folder autoexecute sesuai dengan executor yang Anda gunakan:
